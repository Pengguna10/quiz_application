...
def add_questions():
    questions = [
        ...
        ('What will the green cliff look like if it falls into the Red Sea?', 'Wet?', 'Red', 'Wont Change', 'Purple'),
        ...
        ('What is bigger than an elephant and weighs nothing?', 'Shadow of an elephant', 'A balloon', 'A parachute', 'A cloud'),
        ('What is in my pocket?', 'Ring', 'Fist', 'Hole', 'Bagel')
    ]
    open()
